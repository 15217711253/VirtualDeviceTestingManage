...
namespace VirtualDeviceManage.App.ViewModel
{
    public class VrDeviceDbugViewModel : VrDeviceViewModelBase
    {
        ...
        private ICommProtocol commProtocol { get; set; }
        ...
        private void InitialNetServer()
        {
            ...
            if (server == null)
            {
                ...
                // 获取接口名称
                //var CommProtocolName = base.Source.DeviceType.CommProtocol.Name;
                ...
                var CommProtocol = "VirtualDeviceManage.App.CommProviders."+ this.Source.CommProtocol+ "CommProtocol";

                Type type = Type.GetType(CommProtocol, false);
                if (type == null)
                {
